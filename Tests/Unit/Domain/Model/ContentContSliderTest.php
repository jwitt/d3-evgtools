...
/**
 * Test case for class Tx_D3Evgtools_Domain_Model_ContentContSlider.
 *
 * @version $Id$
 ...
 */
class Tx_D3Evgtools_Domain_Model_ContentContSliderTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_D3Evgtools_Domain_Model_ContentContSlider
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_D3Evgtools_Domain_Model_ContentContSlider();
	}
