...
/**
 * Test case for class Tx_D3Evgtools_Domain_Model_MagazineSlider.
 *
 * @version $Id$
 ...
 */
class Tx_D3Evgtools_Domain_Model_MagazineSliderTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
