...
/**
 * Test case for class Tx_D3Evgtools_Domain_Model_CntBookSlider.
 *
 * @version $Id$
 ...
 */
class Tx_D3Evgtools_Domain_Model_CntBookSliderTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_D3Evgtools_Domain_Model_CntBookSlider
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_D3Evgtools_Domain_Model_CntBookSlider();
	}
